...
(function() {
  var app, coffee, compile, css, database, diary, express, fs, html, http, jqm, jquery, js, mobile, nib, nodejs, others, path, routes, rwd, stylus;
  ...
  require("jade").filters.code = function(block) {
    return block.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/#/g, "&#35;").replace(/&lt;mark&gt;/g, "<mark>").replace(/&lt;\/mark&gt;/g, "</mark>").replace(/\\&lt;mark\\&gt;/g, "&lt;mark&gt;").replace(/\\&lt;\/mark\\&gt;/g, "&lt;/mark&gt;").replace(/"/g, "&quot;");
  };
