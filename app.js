...
(function() {
  var app, coffee, compile, css, diary, express, fs, html, http, jqm, jquery, js, material, mobile, mongodb, nib, nodejs, others, path, routes, rwd, stylus;
  ...
  */
  ...
  app.get("/mongodb/:id", mongodb.mongodb);
